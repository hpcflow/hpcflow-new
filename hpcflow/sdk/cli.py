...
def _make_open_CLI(app: BaseApp):
    ...
    @click.option("--path", is_flag=True, default=False)
    @workflow_ref_type_opt
    def workflow(workflow_ref, ref_type, path:bool=False):
...
def make_cli(app: BaseApp):
    ...
    def configure_env(name:str, use_current_env:bool, setup:list[str]|None=None, env_source_file:str|None=None):
